...
void bubble_sort(int a[], int sz, bool smallest_to_largest=true);
...
int main()
{
	...
	cout << "Sorted array (smallest to largest):" << endl;
	output_array(my_array,SIZE);
	
	bubble_sort(my_array,SIZE,false);
	cout << "Sorted array (largest to smallest):" << endl;
	output_array(my_array,SIZE);
...
void bubble_sort(int a[], int sz, bool smallest_to_largest)
{
	bool swapped, do_a_swap;

...
{
	// step 0
	string filename; // name of file for input
	ifstream infile; // ifstream object for our input file
	float input_value; // value read in from the file
	float min, max, sum; // variables for min value, max value, and sum
	...
	else
	{
		...
		cout << "Read in " << setw(5) << counter << " data values" << endl;
